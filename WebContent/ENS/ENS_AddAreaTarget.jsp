...
<form action="ENS_AreaTargetServlet" method="get" name="formAddNode" id="formAddNode">		
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="section" class="inp">
					...
					<select class="form-control form-control-sm col-md-12"  style="width: 100%;" id="area_nam" name="area_nam" onchange="disForm(this)">	    	    	
			      		...
			      		<option>010 TOTAL POWER</option>
			      		<option>010 TOTAL RADIAL POWER</option>
			      		<option>020 VARIABLE POWER</option>
			      		<option>030 FIXED POWER</option>
			      		<option>040 MIXERS</option>
			      		<option>050 EXTRUDERS</option>
			      		<option>060 CALENDERS</option>
			      		<option>070 BEAD</option>
			      		<option>080 LIGHTING MLDB</option>
			      		<option>090 BUILDINGS AND CUTTER</option>
			      		<option>100 CURING</option>
			      		<option>110 FF AUTOMATION</option>
			      		<option>120 FGS</option>
			      		<option>130 TYRE TESTING</option>
			      		<option>140 UTILITY</option>
			      		<option>150 CHILLERS</option>
			      		<option>160 AIRWASHERS</option>
			      		<option>170 FCWS</option>
			      		<option>180 VACUUM SYSTEM</option>
			      		<option>190 HYDRAULIC SYSTEM</option>				      					      
			    	</select>	
				</label>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
