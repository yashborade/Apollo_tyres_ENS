...
<script type="text/javascript">
		...
		{	
			if(element.value=="Filter_Equip")
			{
				document.formAddNode.action.value="Filter_Equip";
...
<form action="ENS_ChartsServlet" method="get" name="formAddNode" id="formAddNode">		
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="section" class="inp">
					<span class="label">Select Equipment </span>
					<script>
					...
					source : function(request, response) {
						$.ajax({
							url : "ENS_HelpServlet?field=search_CalEquip",
							data : request,
							dataType : "json",
				...
				<input type="text" id="equip" name="equip" placeholder="&nbsp;" onblur="getEmpDetail()">
				</label>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
	...
	<div class="row">
			<div class="col-md-12 text-center">
				...
				<input class="my-3 py-2" type="button" value="Filter_Equip" id="Filter_Equip" onclick="submitValues(this)" style=" border:2px solid black; letter-spacing: 2px; font-weight:300; border-radius:20px 0  0 20px; background-color: #e94e0f; color:white; font-size: 14pt; " />
