...
<%
				...
				{
					genReports = (ArrayList<ENS_CalAreaGroupBean>) request.getAttribute("charts");
...
<%
	...
	for(ENS_CalAreaGroupBean lst1 : genReports)
	{
		for(ENS_AreaTargetBean lst2 : genReports1)
		{
			lst_date.add(lst1.getAREA_DATE().toString().substring(0,10));
			lst_nam.add(lst1.getAREA_NAM());
