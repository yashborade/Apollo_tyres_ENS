...
<script type="text/javascript">
		...
		{	
			if(element.value=="Filter_Area")
			{
				document.formAddNode.action.value="Filter_Area";
...
<form action="ENS_ChartsServlet" method="get" name="formAddNode" id="formAddNode">		
	...
	<div class="container mt-3">
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<input type="text" id="area" name="area" placeholder="&nbsp;" onblur="getEmpDetail()">
				</label>
			</div>
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
	...
	<div class="row">
			<div class="col-md-12 text-center">
				...
				<input class="my-3 py-2" type="button" value="Filter_Area" id="Filter_Area" onclick="submitValues(this)" style=" border:2px solid black; letter-spacing: 2px; font-weight:300; border-radius:20px 0  0 20px; background-color: #e94e0f; color:white; font-size: 14pt; " />
