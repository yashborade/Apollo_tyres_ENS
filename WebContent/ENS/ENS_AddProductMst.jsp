...
<script type="text/javascript">
		...
		{	
			if(element.value=="Enter"){
					...
					document.formEdit.action.value="Enter";
...
<form action="ENS_AddProductMstServlet" method="get" name="formEdit">		
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<script>
					...
					source : function(request, response) {
						$.ajax({
							url : "ENS_HelpServlet?field=search_equip1",
							data : request,
							dataType : "json",
	...
	<div class="row">
			<div class="col-md-12 text-center">
				...
				<input class="my-3 py-2" type="button" value="Enter" id="Enter" onclick="submitValues(this)" style=" border:2px solid black; letter-spacing: 2px; font-weight:300; border-radius:20px 0  0 20px; background-color: #e94e0f; color:white; font-size: 14pt; " />
