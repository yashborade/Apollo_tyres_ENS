...
<script type="text/javascript">
		function submitValues(element)
		{
			...
			if(a == true)
			{
					...
					document.formEdit.action.value="Confirm";
...
<form action="ENS_AreaGroupServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Enter Area Name</span>
				<script>
					...
					source : function(request, response) {
						$.ajax({
							url : "ENS_HelpServlet?field=search_area1",
							data : request,
							dataType : "json",
	...
	<div class="row">
			<div class="col-md-12 text-center">
				...
				<input class="my-3 py-2" type="button" value="Confirm" id="Confirm" onclick="submitValues(this)" style=" border:2px solid black; letter-spacing: 2px; font-weight:300; border-radius:20px 0  0 20px; background-color: #e94e0f; color:white; font-size: 14pt; " />
