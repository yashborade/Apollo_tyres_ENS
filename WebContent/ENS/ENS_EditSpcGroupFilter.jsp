...
<%
	...
	groupBean = (ENS_AddSpcGroupBean) request.getAttribute("groupupdate");
	
	System.out.println("group Data :"+groupBean);
	
	ENS_AddSpcGroupBean groupData = null;
	if(request.getAttribute("groupupdate") != null)
	{
		System.out.println("into groupdata");
		groupData = (ENS_AddSpcGroupBean) request.getAttribute("groupupdate");
		//System.ot.println("sz"+ftData.size());
	}
	else
	{
		groupData = new ENS_AddSpcGroupBean();
		//out.println("no records to display...");	
	} 
%>
<jsp:include page="/ENS/ENS_Header.jsp"/>
<form action="ENS_AddSpcGroupServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		<div class="row">
    		...
    		<tr>
			<tr>    
    		<th>Area Name  :- </font> <input type="text" name="fiddadd" id="fiddadd" value= "<%=groupData.getSPC_GRP() %>" placeholder="Fidder Added " style="height: 50px; width: 1135px"/></p></th>
    		</tr>
			</table>
	</div>
</div>
