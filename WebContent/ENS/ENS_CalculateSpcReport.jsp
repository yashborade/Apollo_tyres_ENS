<%@page import="beans.ENS_CalSpcGroupBean"%>
...
<%@ include file="/ENS/ENS_JS_Container.jsp"  %>
	...
	{
		arrData = (String[][]) request.getAttribute("Reportspc");
...
<form action="ENS_CalSpcGroupServlet" method="post" name="formAddEquip">
	
	<center>
		<h3 class="my-3 text-success">Total SPC Report</h3>
		...
		<%
				...
				<tr>
					<%colTot=0; %>
					<td><a href="ENS_CalSpcGroupServlet?action=drill_report&ename=<%= arrData[i][1]%>
																			  &date1=<%=sDate%>
	...
	<script type="text/javascript">
			...
			{				
				$("#userTbl").table2excel({
				    exclude:".noExl",
				    name:"Worksheet Name",
				    filename:"Spc Group Master Report",//do not include extension
