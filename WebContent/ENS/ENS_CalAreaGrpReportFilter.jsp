...
<title>Area Group Calculation Report</title>
...
<form action="ENS_CalculateAreaGroupServlet" method="get" name="formAddNode" id="formAddNode">		
	...
	<div class="container mt-3">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Enter From Date*</span>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="equip_nam" class="inp">
				<span class="label">Enter To Date*</span>
