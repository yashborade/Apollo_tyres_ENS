...
<script type="text/javascript">
		...
		{	
			if(element.value=="Insert"){
				...
				if (document.getElementById("area_nam").value=="")
				{
					document.getElementById("errorMsg").innerHTML="Please Enter Area Name.";
				}
				else if (document.getElementById("area_nam").value!="")
				{
...
<form action="ENS_AreaGroupServlet" method="get" name="formAddGroup" id="formAddGroup">		
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="area_nam" class="inp">
				<span class="label">Area Name* </span>
				<script>
				$(document).ready(function() {
					$("#area_nam").autocomplete({
					width : 250,
					max : 10,
					delay : 100,
					minLength : 1,
					...
					source : function(request, response) {
						$.ajax({
							url : "ENS_HelpServlet?field=search_area",
							data : request,
							dataType : "json",
					...
					<input type="text" id="area_nam" name="area_nam" placeholder="&nbsp;" onblur="getEmpDetail()">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Equipment to be Added* </span>
	...
	$(function() {   
	    ...
	    $("#search")
	      .autocomplete({
	        minLength: 0,
	        source: function( request, response ) {
	        	$.getJSON('ENS_HelpServlet?field=search_group',{
