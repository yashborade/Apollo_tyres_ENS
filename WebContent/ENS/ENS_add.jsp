...
<script type="text/javascript">
		...
		{	
			if(element.value=="Insert"){
				...
				{
					document.getElementById("errorMsg").innerHTML="Please Select Section.";
				}
				if (document.getElementById("nod_nam").value=="" && document.getElementById("section").value=="--Select--")
				{
					document.getElementById("errorMsg").innerHTML="Please Select Section and Enter Node Name.";
				}
				else if (document.getElementById("nod_nam").value!="" && document.getElementById("section").value!="--Select--")
				{
