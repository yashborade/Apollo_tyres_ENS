...
<title>Feeder Group Calculation Report</title>
...
<form action="ENS_CalculateGroupServlet" method="get" name="formAddNode" id="formAddNode">		
	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-xs-12 text-center pt-1" style="border-radius:20px 20px 0 0; font-weight :bold; font-size:16pt; letter-spacing: 1px;  width: 100%; height:40px; background-color: #a78cc2;">
				Feeder Group Calculation Report
			</div>
