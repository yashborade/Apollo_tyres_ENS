...
<title>Total Area Group Report</title>
...
<form action="ENS_CalculateAreaGroupServlet" method="post" name="formAddEquip">
	
	<center>
		<h3 class="my-3 text-success">Total Area Group Report</h3>
		...
		<%
				...
				<tr>
					<%colTot=0; %>
					<td><a href="ENS_CalculateAreaGroupServlet?action=drill_report&ename=<%= arrData[i][1]%>
																			  &date1=<%=sDate%>
	...
	<script type="text/javascript">
			...
			{				
				$("#userTbl").table2excel({
				    exclude:".noExl",
				    name:"Worksheet Name",
				    filename:"Area Group Master Report",//do not include extension
