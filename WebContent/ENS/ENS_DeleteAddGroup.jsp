	...
	<div class="container mt-3">
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				...
				<span class="label">Enter Equipment Name</span>
				<script>
					$(document).ready(function() {
					$("#equip_nam").autocomplete({
					width : 250,
					max : 10,
					delay : 100,
					minLength : 1,
					...
					source : function(request, response) {
						$.ajax({
							url : "ENS_HelpServlet?field=search_equip",
							data : request,
							dataType : "json",
					...
					<input type="text" id="equip_nam" name="equip_nam" placeholder="&nbsp;" onblur="getEmpDetail()">
