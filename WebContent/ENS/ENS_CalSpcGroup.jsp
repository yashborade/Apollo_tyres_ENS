...
<title>Calculate SPC Group</title>
...
<form action="ENS_CalSpcGroupServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		...
		<div class="row py-3" style="border: 2px solid #a78cc2;">
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-5 my-1 align-bottom">
				<label for="equip_nam" class="inp">
				<span class="label">Enter Tonnage*</span>
					<input type="text" id="ton" name="ton" placeholder="&nbsp;" onblur="getEmpDetail()">
