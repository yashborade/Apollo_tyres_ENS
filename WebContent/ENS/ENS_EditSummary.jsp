...
<title>Summary Filter group</title>
...
%>
<%
	ENS_SummaryBean groupBean = null;
	groupBean = (ENS_SummaryBean) request.getAttribute("sumread");
	
	System.out.println("group Data :"+groupBean);
	
	ENS_SummaryBean groupData = null;
	if(request.getAttribute("sumread") != null)
	{
		System.out.println("into groupdata");
		groupData = (ENS_SummaryBean) request.getAttribute("sumread");
		//System.ot.println("sz"+ftData.size());
	}
	else
	{
		groupData = new ENS_SummaryBean();
...
<form action="ENS_SummaryMasterReportServlet" method="get" name="formEdit">		
	...
	<div class="container mt-3">
		<div class="row">
    		...
    		<th>Difference :-</font> <input type="text" name="read" id="read" value= "<%=groupData.getDIFF() %>" placeholder="Fidder Subtract" style="height: 50px; width:1135px" /></p></th>
			</tr>
			</table>
	</div>
</div>
